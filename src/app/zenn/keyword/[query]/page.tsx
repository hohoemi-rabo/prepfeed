...
export default function ZennKeywordPage() {
  ...
  const handleKeywordSearch = (e: React.FormEvent) => {
    ...
    if (keywordQuery.trim()) {
      router.push(
        `/zenn/keyword/${encodeURIComponent(keywordQuery.trim())}`
      );
    }
  };
        ...
        <form onSubmit={handleKeywordSearch} className="w-full">
          <div className="relative">
            <input
              ...
              className="w-full pl-12 pr-24 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-[#3EA8FF] focus:border-transparent transition-all duration-200"
            />
            ...
            <button
              type="submit"
              className="absolute right-2 top-1/2 -translate-y-1/2 px-4 py-1.5 bg-gradient-to-r from-[#3EA8FF] to-[#2B8AD9] text-white rounded-md text-sm font-medium hover:opacity-90 transition-opacity"
            >
              検索
            </button>
          </div>
        ...
        <div className="card">
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0">
              <div className="w-12 h-12 bg-gradient-to-r from-[#3EA8FF] to-[#2B8AD9] rounded-lg flex items-center justify-center">
